...
class ComedyActivity : AppCompatActivity() {
    ...
    private val evName = "Stand Up Comedy by The Laughter Club"
    private val evDate = "20-07-2023"
    private val evTime = "17:00"
    private val evLoc = "Willson College, Mumbai, India"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        userEventsRef.orderByChild("title").equalTo(evName).addListenerForSingleValueEvent(object : ValueEventListener {
            ...
            override fun onCancelled(databaseError: DatabaseError) {
                ...
                Toast.makeText(this@ComedyActivity, "Backend error, please try again after sometime!", Toast.LENGTH_SHORT).show()
            }
        })
    }
            ...
            if (isEnrolled) {
                ...
                userEventsRef.orderByChild("title").equalTo(evName).addListenerForSingleValueEvent(object :
                    ...
                    override fun onDataChange(dataSnapshot: DataSnapshot) {
                        ...
                        Toast.makeText(this@ComedyActivity, "Un-enrolled", Toast.LENGTH_SHORT).show()
                    }

                    override fun onCancelled(databaseError: DatabaseError) {
                        Toast.makeText(this@ComedyActivity, "Error updating the changes", Toast.LENGTH_SHORT).show()
                    }
                })
            } else {
